...
def send_covert_message(ip: str = "127.0.0.1", port: int=9000, message: str="Hello World"):
    icmp_header: bytes = struct.pack(icmp_header_format, icmp_type, icmp_code, icmp_checksum, 0) # Rest of header field is irrelevant for our message
    ...
    print(f"Type: {icmp_type}, Code: {icmp_code}, Checksum: {icmp_checksum}, Data: {icmp_payload}")
